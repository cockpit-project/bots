...
def print_console_output(ec2: EC2Client, instance: InstanceTypeDef) -> None:
...
def _ensure_nested_virt_support(ec2: EC2Client) -> None:
    ...
    shapes = ec2._service_model._shape_resolver._shape_map  # type: ignore[attr-defined,unused-ignore]
